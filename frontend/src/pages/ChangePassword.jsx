...
import api from '../api';
import { PageHeader, Field, PasswordInput, Btn, FormGrid, TableCard } from '../components/UI';
      ...
      <TableCard>
        <FormGrid>
          <Field label="Шинэ нууц үг">
            <PasswordInput value={pw1} onChange={e => setPw1(e.target.value)} placeholder="Doc1234!" />
          </Field>
          <Field label="Дахин бичих">
            <PasswordInput value={pw2} onChange={e => setPw2(e.target.value)} placeholder="Doc1234!" />
          </Field>
        </FormGrid>
