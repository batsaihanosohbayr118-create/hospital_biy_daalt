...
router.get('/doctors',                    authenticate, authorize('admin', 'doctor'), getAllDoctors);
...
router.post('/appointments',                  authenticate, authorize('admin', 'doctor'), createAppointment);
...
router.delete('/appointments/:id',            authenticate, authorize('admin', 'doctor'), cancelAppointment);
